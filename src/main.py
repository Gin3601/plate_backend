...
def info_template(image_type: str):
    if image_type == "商品图":
        return """
        生成一张商品主图，符合电商产品主图标准
        高端商业产品摄影风格的商品主图，严格遵循主流电商平台的主图规范。画面采用精致的多层堆叠构图，通过精准的光影控制与层次布局，充分展现产品的立体结构、表面纹理与材质细节，凸显其优质质感与精湛工艺。主体产品居中放置，占据画面主要视觉焦点，周围留有适度呼吸空间，确保视觉清爽不拥挤。背景为纯净柔和的浅灰或象牙白色渐变，无任何干扰元素，营造出高级、专业的展示环境。光线经过专业布光设计，均匀柔和地覆盖产品表面，同时在边缘处形成细腻高光，巧妙勾勒出产品的轮廓与关键细节。整体色调统一协调，以低饱和、高明度的中性色为主，强化产品的现代感与高端定位。画面无任何文字、logo或装饰性元素，完全聚焦于产品本身，符合现代电商平台对高品质、高转化率商品主图的视觉标准与商业需求。
        """
    elif image_type == "尺寸图":
        return """
        以我提供的产品主图为主体，制作一张电商平台用的“PRODUCT SIZE”尺寸信息图。
        ...
        return """
        生成一张商品的展示图，顶部为“WEIGHT UPGRADE”标题，下方说明文字“Heavy Duty Thick Paper, Stronger Load-bearing Capacity”。底部横向排列五个功能图标（Non-slip、More Solid、More Heat Resistant、Cut Resistant、Leak Proof），图标设计简洁且与主图色调一致。整体突出产品耐用性和实用场景。
        ...
        return """
        生成一张带有商品的使用场景图片
        呈现温馨雅致的节日餐桌氛围，构图精心安排空间层次和视觉引导。光线柔和自然，色彩搭配协调舒适，营造令人愉悦的节日用餐环境。
        细节处理精致细腻，整体氛围轻松优雅，既突出产品又保持场景的真实感，符合现代电商对场景化营销图片的高标准视觉要求。
        """
    elif image_type == "场景图2":
        return """
        生成一张带有商品的使用场景图片
        生动展现欢乐节日聚餐的热烈场景，构图富有动感和生活气息。通过人物互动的自然刻画和环境细节的精心布置，营造出浓厚的节日欢庆氛围。
        光影运用生动自然，色彩明快富有节日特色，整体风格真实亲切，具有强烈的场景代入感和情感共鸣，完美展现产品在欢乐聚会中的重要角色。
        """
    else:
        return ""
